        ...
        <div class="superadmin-user-card ${isTargetSuperAdmin ? 'is-superadmin-card' : ''}" id="sa-card-${escapeHtml(u.username)}">
          <div class="superadmin-user-header" onclick="toggleSuperAdminUserDrawer('${escapeHtml(u.username)}')">
            ...
            <div class="superadmin-user-actions-bar" onclick="event.stopPropagation()">
              ...
              ${!isCurrent ? `
                ${!isTargetSuperAdmin ? `
                  <button class="btn-mgmt-action" style="color: #f59e0b;" title="Promosikan Menjadi Super Admin (👑)" aria-label="Promosikan Menjadi Super Admin" onclick="adminChangeRolePrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}', 'Super Admin')">
                  ...
                  <button class="btn-mgmt-action action-pin" title="Reset PIN Akun CS Ini" aria-label="Reset PIN Akun CS Ini" onclick="adminResetPinPrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                      <path d="M21 2l-2 2m-1.5 1.5L14 9l-3-3 2.5-2.5L16 5l2-2 3 3-2 2z"/>
                      <circle cx="7.5" cy="16.5" r="4.5"/>
                    </svg>
                  </button>
                  <button class="btn-mgmt-action action-session" title="Reset Total Seluruh Sesi CS Ini" aria-label="Reset Total Seluruh Sesi CS Ini" onclick="adminClearSessionPrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                      <path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/>
                    </svg>
                  </button>
                  <button class="btn-mgmt-action action-delete" title="Hapus Akun CS Ini" aria-label="Hapus Akun CS Ini" onclick="deleteUserPrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                ...
                ` : `
                  <button class="btn-mgmt-action" style="color: #94a3b8;" title="Turunkan Menjadi Customer Service (CS)" aria-label="Turunkan Menjadi Customer Service" onclick="adminChangeRolePrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}', 'Customer Service')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                      <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/>
                    </svg>
                  </button>
                  <button class="btn-mgmt-action action-pin" title="Reset PIN Akun Super Admin Ini" aria-label="Reset PIN Akun Super Admin Ini" onclick="adminResetPinPrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                      <path d="M21 2l-2 2m-1.5 1.5L14 9l-3-3 2.5-2.5L16 5l2-2 3 3-2 2z"/>
                      <circle cx="7.5" cy="16.5" r="4.5"/>
                    </svg>
                  </button>
                  <button class="btn-mgmt-action action-delete" title="Hapus Akun Super Admin Ini" aria-label="Hapus Akun Super Admin Ini" onclick="deleteUserPrompt('${escapeHtml(u.username)}', '${escapeHtml(name)}')">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false">
                      <polyline points="3 6 5 6 21 6"/>
                      <path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/>
                      <path d="M10 11v6M14 11v6"/>
      ...
      html += `
        <div class="settings-store-item">
          ...
          <div class="settings-store-actions">
            ...
            <button class="btn-icon" title="Edit" aria-label="Edit Toko" onclick="openEditModal('${store.id}')">
            ...
            <button class="btn-icon danger" title="Hapus" aria-label="Hapus Toko" onclick="deleteStore('${store.id}')">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true" focusable="false">
                <polyline points="3 6 5 6 21 6"/>
                <path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/>
                <path d="M10 11v6M14 11v6"/>
