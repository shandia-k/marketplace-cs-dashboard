      ...
      html += `
        <div class="settings-store-item">
          ...
          <div class="settings-store-actions">
            ...
            <button class="btn-icon" title="Clear Cache & Reload Toko Ini (Login Tetap Aman)" aria-label="Clear Cache & Reload Toko" onclick="clearStoreCacheAndReload('${store.id}')">
            ...
            <button class="btn-icon" title="Reset Total Sesi Toko Ini (Logout)" aria-label="Reset Total Sesi Toko" onclick="deepCleanStoreAndConfirm('${store.id}')" style="color: #f59e0b;">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
