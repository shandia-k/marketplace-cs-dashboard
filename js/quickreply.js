      ...
      <div class="qr-template-card" data-id="${tpl.id}">
        ...
        <div class="qr-card-actions">
          <button class="qr-btn-insert" title="Ketik langsung ke chat marketplace aktif" onclick="insertTemplateToActiveChat('${tpl.id}')">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true" focusable="false">
              <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>
            </svg>
            Ketik ke Chat
          </button>
          <button class="qr-btn-action-icon" title="Salin Pesan" onclick="copyTemplateToClipboard('${tpl.id}')" aria-label="Salin Pesan">
          ...
          <button class="qr-btn-action-icon" title="Edit Template" onclick="openEditTemplateModal('${tpl.id}')" aria-label="Edit Template">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true" focusable="false">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
            </svg>
          </button>
          <button class="qr-btn-action-icon danger" title="Hapus Template" onclick="deleteSmartTemplate('${tpl.id}')" aria-label="Hapus Template">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true" focusable="false">
