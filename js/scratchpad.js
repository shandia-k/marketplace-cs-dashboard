...
const localDebounce = window.debounce || function(func, wait) {
  let timeout;
...
const debouncedSaveScratchpadState = localDebounce(saveScratchpadState, 500);

loadScratchpadState();

// Flush any pending debounced saves before unloading to prevent data loss
