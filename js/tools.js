      ...
      <div class="cnote-card">
        ...
        <div class="cnote-footer">
          ...
          <div class="cnote-actions">
            <button class="qr-btn-action-icon btn-cnote-greet" title="Ketik Sapaan Khusus ke Chat" data-id="${n.id}" aria-label="Ketik Sapaan Khusus ke Chat">
            ...
            <button class="qr-btn-action-icon" title="Edit Catatan" onclick="openEditNoteModal('${n.id}')" aria-label="Edit Catatan">
            ...
            <button class="qr-btn-action-icon danger" title="Hapus Catatan" onclick="deleteCustomerNote('${n.id}')" aria-label="Hapus Catatan">
